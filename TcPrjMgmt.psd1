...
FunctionsToExport = @('Start-MessageFilter', 'Stop-MessageFilter', 'New-DteInstance', 'Close-DteInstace', 'Export-TcProject', 'Install-TcLibrary', 'Uninstall-TcLibrary')
